...
2. Finish remaining hot-path allocation tightening.
...
3. Replace `System.Type` fact/output identity with lightweight ids.
...
4. Add focused diagnostics for reduction failures.
...
5. Validate transactional reducer semantics with tests.
...
6. Harden commit conflict behavior.
